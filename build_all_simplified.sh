...
conda build $recipes_dir/conda-ambertools-single-python --py 2.7 $notest || exit 1
...
conda build $recipes_dir/conda-ambertools-combine-pythons $notest # don't need to provide python version here. 
